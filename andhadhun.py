...
# Form implementation generated from reading ui file 'andhadhun.ui'
#
...
class Ui_Andhadhun(object):
    def setupUi(self, Andhadhun):
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("speech.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("text.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
    ...
    def retranslateUi(self, Andhadhun):
        ...
        Andhadhun.setWindowTitle(_translate("Andhadhun", "MainWindow"))
